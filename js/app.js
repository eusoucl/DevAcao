...
function carregarPagina() {
        ...
        conteudo.innerHTML = `
            ...
            <section>
                ...
                <article>
                    ...
                    <button type="button" id="abrir-modal">
                        Ver mensagem
                    </button>
                </article>
            </section>
            ...
            >
                <div class="modal-conteudo">
                    ...
                    <h2 id="titulo-modal">Obrigado!</h2>
    ...
    conteudo.innerHTML = `
        <section class="iniciativas">
            ...
            <p>
                Conheça alguns dos projetos que aproximam mais pessoas do mundo
                da programação, de forma gratuita.
            </p>
    ...
    conteudo.innerHTML = `
        <section>
            ...
            <p>
                Preencha o formulário para fazer parte da rede de colaboradores da DevAção.
            </p>
            ...
            <form id="form-cadastro" novalidate>
                ...
                <fieldset>
                    ...
                    <div>
                        ...
                        <small class="erro" aria-live="polite"></small>
                    </div>
                ...
                <fieldset>
                    ...
                    <div>
                        ...
                        <select id="area" name="area" required>
                            ...
                            <option value="oficina">Oficina de Lógica</option>
